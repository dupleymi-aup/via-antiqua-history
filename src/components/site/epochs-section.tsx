  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-7xl px-4">
        <SectionHeader
          icon={<Hourglass className="h-3.5 w-3.5 text-primary" />}
          label="Исторические эпохи"
          title="Карта эпох античности"
          description="Восемь ключевых эпох — от шумерских городов до падения Константинополя."
          readingTime={<ReadingTime text={epochs.map((e) => e.highlights.join(' '))} className="justify-center mt-2" />}
        />
