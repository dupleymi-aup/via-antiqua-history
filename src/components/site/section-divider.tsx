...
export const SectionDivider = React.memo(function SectionDivider() {
  ...
  return (
    <div
      className="relative h-16 sm:h-20 md:h-24 overflow-hidden bg-background"
      aria-hidden="true"
    >
      ...
      <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 flex items-center justify-center gap-3 sm:gap-4 px-4">
        ...
        <span
          ref={ref}
          className={`flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-full border border-border/50 bg-background shadow-sm transition-all duration-700 ${
      ...
      <div
        className="absolute bottom-0 left-0 right-0 h-[3px] opacity-[0.07] dark:opacity-[0.05]"
        style={{
